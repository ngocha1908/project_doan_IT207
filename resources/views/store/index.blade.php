			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="{{ route('product.category', 'nu') }}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="{{ route('product.category', 'nam') }}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									Men
								</span>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
					 ...
					 <div class="block2-pic hov-img0">
						...
						<img src="{./uploads/{{$item->images->first()['name']}}}" alt="IMG-PRODUCT"> </a>
                        </div>
					</div>
                    <!-- {{ route('product.detail', $item->slug) }} -->
